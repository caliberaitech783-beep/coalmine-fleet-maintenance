...
import {AlertTriangle,CalendarClock,CheckCircle2,CloudCog,Database,Download,FileArchive,FolderOpen,HardDrive,History,KeyRound,RefreshCw,RotateCcw,Save,ShieldCheck,Upload} from 'lucide-react';
...
export default function BackupAdministration({section='Backup',session,onNavigate=()=>{}}){
  ...
  return <section className="panel pagepanel backup-admin-page">
    ...
    {active==='Backup'&&<div className="backup-content">
      ...
      <div className="backup-section-heading"><div><h2>Backup history</h2><p>Recent automatic, manual, export, and pre-restore recovery points.</p></div></div><BackupHistory history={data.history} onDownload={downloadStored} busy={Boolean(busy)} />
    </div>}
