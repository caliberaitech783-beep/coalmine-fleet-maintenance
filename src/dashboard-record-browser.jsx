...
export default function DashboardRecordBrowser({ rows, regions, initialRegion = "", initialSite = "", requestRecords = false, lifecycleRecords = false, ActionsTable, Status, formatDate }) {
