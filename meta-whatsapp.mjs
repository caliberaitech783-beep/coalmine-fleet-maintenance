...
export const META_WORKFLOW_TEMPLATES={
  ...
  requestOpened:{name:'nerve_request_opened',body:'Nerve Center: Request {{1}} opened at {{2}} for {{3}} by {{4}}. Please open Nerve Center to review it.',example:['REQ-1787566831835','24 Aug 2026, 3:49 PM','Majri OB','Production User']},
  requestIdle:{name:'nerve_request_idle',body:'Nerve Center: Request {{1}} was marked Idle by {{2}}. Maintenance Manager approval is required to make it on road.',example:['REQ-1787566831835','Maintenance User']},
  requestClosed:{name:'nerve_request_closed',body:'Nerve Center: Request {{1}} closed at {{2}} by {{3}}. It is now available in Closed History.',example:['REQ-1787566831835','24 Aug 2026, 6:10 PM','Maintenance User']},
