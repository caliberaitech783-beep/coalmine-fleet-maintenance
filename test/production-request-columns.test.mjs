...
test("production request table follows the approved column order", () => {
  ...
  assert.match(source, /const PRODUCTION_REQUEST_COLUMNS = \["door", "equipment", "model", "site", "breakdownDays", "category", "delayedReason", "complaint", "start", "status", "dailyRemarks", "ref", "createdBy"\];/);
