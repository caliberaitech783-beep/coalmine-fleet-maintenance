...
test("maintenance history hides only closed requests by the two specified closers", () => {
  for (const closedBy of ["Anoop Paul", "maimaintenance manager", " ANOOP PAUL "]) {
  ...
  for (const closedBy of ["Sanskar Manohare", "SUNIL KUMAR MAHATO", "", "Anoop Paul Other"]) {
