...
test('production first-trip pending queue includes only today on-road records and excludes completed production entries', () => {
  const records = [
    {...base, ref: 'old-pending', status: 'Closed', start: '2026-09-08 09:00', closedAt: '2026-09-08 10:00', productionFirstTripAt: '', door: 'D0'},
    {...base, ref: 'yesterday-pending', status: 'Closed', start: '2026-09-21 00:00', closedAt: '2026-09-21 23:59', productionFirstTripAt: '', door: 'D1'},
