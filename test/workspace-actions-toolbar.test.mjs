...
test("every operational workspace places Actions beside the status selector", () => {
  ...
  assert.match(workflowTable, /<ActionsTable className="workflow-table" closedTimeAfterStarted=\{closedTimeAfterStarted\} toolbarTarget=\{combinedToolbarTarget\} toolbarPortal>/);
