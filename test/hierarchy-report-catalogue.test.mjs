...
test('hierarchy report groups carry the Reports menu headings in menu order',()=>{
  ...
  assert.deepEqual(byGroup.C,['Report for On Road / Off Road & Idle','Vehicle Transfer Report','Total Equipment / Vehicle Location Wise','Recent Breakdown Cases','Summary Report','Request Stage Timing']);
